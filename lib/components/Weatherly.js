...
export default class Weatherly extends Component {
  ...
  handleClick(location, testApi) {
    const cityState = location.split(', ');
    const api = testApi || `http://api.wunderground.com/api/${apiKey}/forecast/hourly/forecast10day/conditions/q/${cityState[1]}/${cityState[0]}.json`;
